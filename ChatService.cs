...
public class ChatService : IDisposable
{
    ...
    {
        Console.WriteLine("[GeminiBridge] Assembly unloading. Disposing active Playwright browser sessions...");
    ...
    public IPage _page = null!;              // set in InitializePlaywrightAsync
    
    // Made public so caller can read _page.Url in step 5.5
    ...
    // -----------------------------------------------------------------------
    public async Task<string> CheckIfLoggedInAsync(bool isBrandNew) // Changed to public for Step 5.2 logic
    {
        if (isBrandNew)
        {
